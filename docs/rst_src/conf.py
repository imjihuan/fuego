# -*- coding: utf-8 -*-
#
# Fuego documentation build configuration file, created by
...
project = u'Fuego'
copyright = u'2017-2022 Sony Corporation'
...
latex_documents = [
    (master_doc, 'Fuego.tex', u'Fuego Documentation',
     u'Cogent Embedded, Tim Bird', 'manual'),
]
...
man_pages = [
    (master_doc, 'fuego', u'Fuego Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Fuego', u'Fuego Documentation',
     author, 'Fuego', 'One line description of project.',
     'Miscellaneous'),
]
